...
//     numero % 2 == 0 ? alert(`El numero ingresado es par`) : alert(`El numero ingresado es impar`)
// }
...
//     X1 <= y && Y1 <= y ? alert(`Las Coordernadas (X1, Y1): (${X1},${Y1}) estan adentro del cuadrado`) : alert(`Las Coordernadas (X1, Y1): (${X1},${Y1}) estan fuera del cuadrado`);
// }
